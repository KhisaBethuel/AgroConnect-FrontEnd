...
function ProfilePage() {
  ...
  const [bio, setBio] = useState(
    "Agricultural Engineer | Sustainable Farming Expert | Tech Enthusiast"
  );
  const [profileImage, setProfileImage] = useState(
    "https://thumbs.dreamstime.com/b/happy-african-farmer-working-countryside-holding-wood-box-fresh-vegetables-215052594.jpg"
  );
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full mx-4">
            ...
            {loadingFollowers || loadingFollowing ? (
              ...
              <div className="divide-y">
                {(showFollowersModal ? followers : following).map(
                  (user, index) => (
