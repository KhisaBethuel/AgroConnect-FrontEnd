...
return (
    <div className="min-h-screen bg-white flex items-center justify-center py-8">
        ...
        <h1 className="text-2xl text-center text-white font-bold mb-6">Publish Your Blog</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Blog Title */}
            <div>
            <label htmlFor="title" className="block text-lg text-white font-medium mb-2">Blog Title:</label>
            <input
                type="text"
                id="title"
                name="title"
          ...
          {/* Image Upload */}
            <div>
            <label htmlFor="image" className="block text-lg text-white font-medium mb-2">Upload Image:</label>
            <input
                type="file"
                id="image"
                name="image"
          ...
          {/* Story Textarea */}
            <div>
            <label htmlFor="story" className="block text-lg text-white font-medium mb-2">Tell Your Story:</label>
            <textarea
                id="story"
                name="story"
                value={story}
